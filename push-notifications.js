...
import { getFirebaseApp, initFirebase, isFirebaseConfigValid } from './firebase-manager.js?v=7cbf9eb';
import { registerPushToken, disablePushToken } from './cloud-push.js?v=7cbf9eb';

function getServiceWorkerUrl() {
  if (typeof globalThis.assetUrl === 'function') {
    return globalThis.assetUrl('sw.js?v=7cbf9eb');
  }
  const path = location.pathname || '/';
  return path.includes('/jugar') ? '../sw.js?v=7cbf9eb' : 'sw.js?v=7cbf9eb';
}
